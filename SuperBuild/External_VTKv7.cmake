...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  set(${CMAKE_PROJECT_NAME}_${proj}_GIT_REPOSITORY "github.com/tokjun/VTK.git" CACHE STRING "Repository from which to get VTK" FORCE)
  set(${CMAKE_PROJECT_NAME}_${proj}_GIT_TAG "a3666e79c6977a15760da7789bf280399f3a7f7d" CACHE STRING "VTK git tag to use" FORCE)
